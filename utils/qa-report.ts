...
export function renderQaReportMarkdown(report: QaRunReport): string {
  ...
  if (report.retriedTests.length) {
    lines.push(
      ...
      '| ---: | ---: | ---: | ---: | ---: |',
      `| ${report.retriedTestSummary.total} | ${report.retriedTestSummary.maximumAttempts} | ${report.retriedTestSummary.retryAttempts} | ${formatDuration(report.retriedTestSummary.averageDurationMs)} | ${formatDuration(report.retriedTestSummary.totalDurationMs)} |`,
      '',
      '## Retried Tests',
      '',
