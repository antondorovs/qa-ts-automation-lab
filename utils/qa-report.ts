...
export function renderQaReportMarkdown(report: QaRunReport): string {
  ...
  lines.push(
    ...
    '',
    '| Status | Quality gate checks | Quality gate passes | Quality gate failures | Quality gate pass rate | Quality gate failure rate | Total tests | Executed tests | Execution rate | Passed tests | Failed tests | Timed out tests | Interrupted tests | Flaky tests | Flaky rate | Skipped tests | Skipped rate | Release blockers | Non-passing executed | Risk score |',
    '| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |',
    `| ${report.releaseReadinessSummary.status} | ${report.releaseReadinessSummary.qualityGateChecks} | ${report.releaseReadinessSummary.qualityGatePasses} | ${report.releaseReadinessSummary.qualityGateFailures} | ${report.releaseReadinessSummary.qualityGatePassRate}% | ${report.releaseReadinessSummary.qualityGateFailureRate}% | ${report.releaseReadinessSummary.totalTests} | ${report.releaseReadinessSummary.executedTests} | ${report.releaseReadinessSummary.executionRate}% | ${report.releaseReadinessSummary.passedTests} | ${report.releaseReadinessSummary.failedTests} | ${report.releaseReadinessSummary.timedOutTests} | ${report.releaseReadinessSummary.interruptedTests} | ${report.releaseReadinessSummary.flakyTests} | ${report.releaseReadinessSummary.flakyRate}% | ${report.releaseReadinessSummary.skippedTests} | ${report.releaseReadinessSummary.skippedRate}% | ${report.releaseReadinessSummary.releaseBlockers} | ${report.releaseReadinessSummary.nonPassingExecuted} | ${report.releaseReadinessSummary.riskScore} |`,
    '',
