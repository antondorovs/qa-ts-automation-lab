...
export function renderQaReportMarkdown(report: QaRunReport): string {
  ...
  lines.push(
    ...
    '',
    '| Status | Quality gate checks | Quality gate failures | Quality gate pass rate | Quality gate failure rate | Release blockers | Non-passing executed | Risk score |',
    '| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |',
    `| ${report.releaseReadinessSummary.status} | ${report.releaseReadinessSummary.qualityGateChecks} | ${report.releaseReadinessSummary.qualityGateFailures} | ${report.releaseReadinessSummary.qualityGatePassRate}% | ${report.releaseReadinessSummary.qualityGateFailureRate}% | ${report.releaseReadinessSummary.releaseBlockers} | ${report.releaseReadinessSummary.nonPassingExecuted} | ${report.releaseReadinessSummary.riskScore} |`,
    '',
