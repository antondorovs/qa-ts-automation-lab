...
export function renderQaReportMarkdown(report: QaRunReport): string {
  ...
  if (report.slowTests.length) {
    lines.push(
      ...
      '## Slow Test Summary',
      '',
      '| Slow tests | Threshold | Minimum duration | Average duration | Maximum duration |',
      '| ---: | ---: | ---: | ---: | ---: |',
      `| ${report.slowTestSummary.total} | ${formatDuration(report.slowTestSummary.thresholdMs)} | ${formatDuration(report.slowTestSummary.minimumDurationMs)} | ${formatDuration(report.slowTestSummary.averageDurationMs)} | ${formatDuration(report.slowTestSummary.maximumDurationMs)} |`,
      '',
      '## Slow Tests',
      '',
