...
export function renderQaReportMarkdown(report: QaRunReport): string {
  ...
  const lines = [
    ...
    '## Metrics',
    '',
    '| Total | Executed | Passed | Failed | Flaky | Skipped | Execution rate | Pass rate | Failure rate | Duration |',
    '| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |',
    `| ${summary.total} | ${summary.executed} | ${summary.passed} | ${summary.failed + summary.timedOut + summary.interrupted} | ${summary.flaky} | ${summary.skipped} | ${summary.executionRate}% | ${summary.passRate}% | ${summary.failureRate}% | ${formatDuration(report.durationMs)} |`,
    '',
    '## Status Breakdown',
    '',
