...
export function renderQaReportMarkdown(report: QaRunReport): string {
  ...
  lines.push(
    ...
    '## Execution Stability',
    '',
    '| Executed | First-pass passed | Retried tests | Recovered after retry | Recovery rate | Unrecovered retries | Unrecovered retry rate | Retry attempts | Average attempts | Retry rate | First-pass rate |',
    '| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |',
    `| ${report.stability.executed} | ${report.stability.firstPassPassed} | ${report.stability.retriedTests} | ${report.stability.recoveredAfterRetry} | ${report.stability.recoveredAfterRetryRate}% | ${report.stability.unrecoveredRetries} | ${report.stability.unrecoveredRetryRate}% | ${report.stability.retryAttempts} | ${report.stability.averageAttempts} | ${report.stability.retryRate}% | ${report.stability.firstPassRate}% |`,
    '',
    '## Regression Risk',
    '',
