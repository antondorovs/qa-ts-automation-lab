...
export function renderQaReportMarkdown(report: QaRunReport): string {
  ...
  if (report.flakyTests.length) {
    lines.push(
      ...
      '## Flaky Test Summary',
      '',
      '| Total | Maximum attempts | Retry attempts | Average duration | Total duration |',
      '| ---: | ---: | ---: | ---: | ---: |',
      `| ${report.flakyTestSummary.total} | ${report.flakyTestSummary.maximumAttempts} | ${report.flakyTestSummary.retryAttempts} | ${formatDuration(report.flakyTestSummary.averageDurationMs)} | ${formatDuration(report.flakyTestSummary.totalDurationMs)} |`,
      '',
      '## Flaky Tests',
      '',
