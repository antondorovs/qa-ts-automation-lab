...
export function renderQaReportMarkdown(report: QaRunReport): string {
  ...
  if (report.nonPassingExecutedTests.length) {
    lines.push(
      ...
      '',
      '| Total | Failed | Timed out | Interrupted | Flaky | Non-passing rate | Average duration | Total duration |',
      '| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |',
      `| ${report.nonPassingExecutedSummary.total} | ${report.nonPassingExecutedSummary.failed} | ${report.nonPassingExecutedSummary.timedOut} | ${report.nonPassingExecutedSummary.interrupted} | ${report.nonPassingExecutedSummary.flaky} | ${report.nonPassingExecutedSummary.nonPassingRate}% | ${formatDuration(report.nonPassingExecutedSummary.averageDurationMs)} | ${formatDuration(report.nonPassingExecutedSummary.totalDurationMs)} |`,
      '',
