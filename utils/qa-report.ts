...
export function renderQaReportMarkdown(report: QaRunReport): string {
  ...
  if (report.flakyTests.length) {
    lines.push(
      ...
      '## Flaky Test Summary',
      '',
      '| Total | Maximum attempts | Retry attempts | Minimum duration | Average duration | Total duration |',
      '| ---: | ---: | ---: | ---: | ---: | ---: |',
      `| ${report.flakyTestSummary.total} | ${report.flakyTestSummary.maximumAttempts} | ${report.flakyTestSummary.retryAttempts} | ${formatDuration(report.flakyTestSummary.minimumDurationMs)} | ${formatDuration(report.flakyTestSummary.averageDurationMs)} | ${formatDuration(report.flakyTestSummary.totalDurationMs)} |`,
      '',
      '## Flaky Tests',
      '',
  ...
  if (report.slowTests.length) {
    lines.push(
      ...
      '## Slow Test Summary',
      '',
      '| Slow tests | Threshold | Average duration | Maximum duration |',
      '| ---: | ---: | ---: | ---: |',
      `| ${report.slowTestSummary.total} | ${formatDuration(report.slowTestSummary.thresholdMs)} | ${formatDuration(report.slowTestSummary.averageDurationMs)} | ${formatDuration(report.slowTestSummary.maximumDurationMs)} |`,
      '',
      '## Slow Tests',
      '',
