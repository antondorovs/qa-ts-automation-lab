...
export function renderQaReportMarkdown(report: QaRunReport): string {
  ...
  lines.push(
    ...
    '## Execution Stability',
    '',
    '| Executed | First-pass passed | Retried tests | Retry attempts | Retry rate | First-pass rate |',
    '| ---: | ---: | ---: | ---: | ---: | ---: |',
    `| ${report.stability.executed} | ${report.stability.firstPassPassed} | ${report.stability.retriedTests} | ${report.stability.retryAttempts} | ${report.stability.retryRate}% | ${report.stability.firstPassRate}% |`,
    '',
    '## Regression Risk',
    '',
