...
- custom QA run intelligence, execution stability, tag coverage, suite performance, regression risk scoring, and release gates
...
- QA reporting: Playwright result aggregation, execution stability, tag coverage, suite performance, flaky detection, risk hotspots, slow-test visibility, and strict release gates
