...
- custom QA run intelligence, quality gate policy visibility, release decisions, release blocker visibility, execution stability, duration profiling, retry, skipped, and untagged test inventories, tag coverage, test classification gates, test area summaries, suite health, suite performance, regression risk scoring, and release gates
...
- QA reporting: Playwright result aggregation, quality gate policy visibility, release decisions, release blocker inventory, execution stability, duration profiling, retry inventory, tag coverage, test classification and thresholds, untagged and skipped test inventories, skipped-test limits, test area summaries, suite health, suite performance, flaky detection, risk hotspots, slow-test visibility, and strict release gates
