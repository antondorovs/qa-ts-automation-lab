...
- custom QA run intelligence, release decisions, execution stability, tag coverage, suite performance, regression risk scoring, and release gates
...
- QA reporting: Playwright result aggregation, release decisions, execution stability, tag coverage, suite performance, flaky detection, risk hotspots, slow-test visibility, and strict release gates
