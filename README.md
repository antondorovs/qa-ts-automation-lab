...
- custom QA run intelligence, quality gate policy visibility, release decisions, release blocker visibility, execution stability, retry and skipped test inventories, tag coverage, test classification, test area summaries, suite health, suite performance, regression risk scoring, and release gates
...
- QA reporting: Playwright result aggregation, quality gate policy visibility, release decisions, release blocker inventory, execution stability, retry inventory, tag coverage, test classification, skipped test inventory and limits, test area summaries, suite health, suite performance, flaky detection, risk hotspots, slow-test visibility, and strict release gates
