...
- custom QA run intelligence, quality gate policy visibility, release decisions, execution stability, retry and skipped test inventories, tag coverage, test classification, test area summaries, suite health, suite performance, regression risk scoring, and release gates
