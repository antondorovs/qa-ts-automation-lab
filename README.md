...
- custom QA run intelligence, quality gate policy visibility, release decisions, execution stability, tag coverage, test classification, skipped test inventory, test area summaries, suite health, suite performance, regression risk scoring, and release gates
