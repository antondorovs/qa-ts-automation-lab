...
- custom QA run intelligence, quality gate policy visibility, release decisions, release blocker visibility, execution stability, retry, skipped, and untagged test inventories, tag coverage, test classification, test area summaries, suite health, suite performance, regression risk scoring, and release gates
