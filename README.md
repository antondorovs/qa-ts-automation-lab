...
- custom QA run intelligence, regression risk scoring, and release gates
...
- QA reporting: Playwright result aggregation, flaky detection, risk hotspots, slow-test visibility, and strict release gates
