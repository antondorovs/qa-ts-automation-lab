...
This folder is the entry point for human-facing project documentation that does not belong to one specific source folder.

Keep folder-specific documentation close to the related code when possible:
