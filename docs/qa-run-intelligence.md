...
The same section includes a duration-budget breach summary with executed and within-budget counts, the within-budget rate, total breaches, breach rate across executed tests, configured threshold, minimum, average, maximum, and total breach duration, plus minimum, average, maximum, and total amounts over budget. It compares breach duration with the duration of all executed tests, exposing the share of runtime concentrated in over-budget tests, and reports how much of total executed duration was spent beyond the configured budgets. Minimum, average, and maximum over-budget rates express the full excess range as percentages of the configured threshold.
