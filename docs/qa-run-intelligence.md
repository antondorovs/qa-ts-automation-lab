...
The same section includes a release-blocker summary with separate failed, timed-out, interrupted, and flaky counts plus the blocker rate across executed tests, average blocker duration, maximum blocker duration, and total blocker duration.
