...
The release decision section includes a readiness summary with the final status, total, passed, and failed quality-gate check counts, quality-gate pass and failure rates, total-, executed-, passed-, failed-, timed-out-, interrupted-, flaky-, and skipped-test counts, test-pass, test-failure, execution, timed-out, interrupted, flaky, skipped, and non-passing-executed rates, release-blocker count, non-passing executed count, and regression risk score. Test-pass, timed-out, interrupted, and non-passing-executed rates use executed tests as their denominator so outcome and infrastructure signals can be compared directly across runs with different suite sizes.
