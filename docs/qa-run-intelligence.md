...
The same section includes a duration-budget breach summary with total breaches, configured threshold, minimum, maximum, and total duration, plus minimum, average, maximum, and total amounts over budget.
