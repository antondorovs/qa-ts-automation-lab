...
The same section includes a duration-budget breach summary with total breaches, configured threshold, minimum and maximum duration, plus minimum, average, and maximum amounts over budget.
