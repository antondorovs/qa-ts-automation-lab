...
The release decision section includes a readiness summary with the final status, total, passed, and failed quality-gate check counts, quality-gate pass and failure rates, total-, executed-, flaky-, and skipped-test counts, execution, flaky, and skipped rates, release-blocker count, non-passing executed count, and regression risk score.
