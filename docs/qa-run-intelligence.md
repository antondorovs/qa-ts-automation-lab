...
The same section includes a non-passing executed summary with total count, status split, non-passing rate across executed tests, average duration, maximum duration, and total duration before the detailed inventory.
