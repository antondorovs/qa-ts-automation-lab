...
The same section includes a duration-budget breach summary with total breaches, configured threshold, minimum and maximum duration, plus minimum, average, maximum, and total amounts over budget.
