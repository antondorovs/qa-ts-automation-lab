...
The same section includes a retried-test summary with total retried tests, recovered-after-retry and unrecovered-retry counts and rates, maximum attempts, retry attempts, minimum duration, average duration, maximum duration, and total retried-test duration.
