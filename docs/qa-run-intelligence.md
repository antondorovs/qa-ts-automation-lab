...
The Markdown summary shows execution and skipped rates across all discovered tests alongside pass rate and failure rate for executed tests. Reviewers can see how much of the suite ran, how much coverage was skipped, and the healthy and unhealthy share of actual executions without manual calculation.
