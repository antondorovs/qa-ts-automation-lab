...
The same section includes a duration-budget breach summary with total breaches, breach rate across executed tests, configured threshold, minimum, average, maximum, and total duration, plus minimum, average, maximum, and total amounts over budget.
