...
The release decision section includes a readiness summary with the final status, failed quality-gate check count and rate, release-blocker count, non-passing executed count, and regression risk score.
